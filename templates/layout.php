...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="/">Green<span>Line</span></a> <small>Тут будет ваш слоган</small></h1>
      </div>
      <div class="clr"></div>
    </div>
  </div>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <?foreach($arCategory as $category):?>
              <li><a href="?category=<?=$category['id'];?>"><?=$category['title'];?></a></li> <?// category - это параметр для фильтрации?>
            <?endforeach;?>
          </ul>
        </div>
      </div>
